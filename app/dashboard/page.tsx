        ...
        <div className="grid grid-cols-3 gap-4 h-[320px]">
          ...
          <div className="col-span-2 bg-white rounded-xl shadow p-4 flex flex-col">
            <div className="flex justify-between mb-2">
              ...
              <button onClick={handleGenerateReport} className="text-indigo-600 text-sm hover:underline">Generate Report</button>
            </div>
            ...
            <div className="flex items-end justify-between flex-1 px-2">
              {revenueData.map((r) => (
                <div key={r.month} className="text-center">
                  <div
                    className={`w-10 rounded-md ${r.active ? "bg-indigo-600" : "bg-blue-400"}`}
          ...
          <div className="bg-white rounded-xl shadow p-4 flex flex-col">
            <div className="flex justify-between mb-3">
              ...
              <button onClick={() => setShowAll(true)} className="text-indigo-600 text-sm hover:underline">View All</button>
            </div>
...
function Card({ title, value, sub, color, onClick }: any) {
  return (
    <div onClick={() => onClick(title)} className="bg-white rounded-xl shadow p-4 cursor-pointer hover:ring-1 hover:ring-gray-300">
